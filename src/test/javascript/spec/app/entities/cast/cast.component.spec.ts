...
import { CastComponent } from 'app/entities/cast/cast.component';
import { CastService } from 'app/entities/cast/cast.service';
import { Cast } from 'app/shared/model/cast.model';

describe('Component Tests', () => {
    describe('Cast Management Component', () => {
        let comp: CastComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CastComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.casts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
