...
describe('Service Tests', () => {
    describe('Torrent Service', () => {
        ...
        let elemDefault: ITorrent;
        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [HttpClientTestingModule]
            });
            injector = getTestBed();
            service = injector.get(TorrentService);
            httpMock = injector.get(HttpTestingController);

            elemDefault = new Torrent(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should update a Torrent', async () => {
                const returnedFromService = Object.assign(
                    {
                        url: 'BBBBBB',
                        hash: 'BBBBBB',
            ...
            it('should return a list of Torrent', async () => {
                const returnedFromService = Object.assign(
                    {
                        url: 'BBBBBB',
                        hash: 'BBBBBB',
