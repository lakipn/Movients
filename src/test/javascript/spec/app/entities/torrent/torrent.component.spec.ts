...
import { TorrentComponent } from 'app/entities/torrent/torrent.component';
import { TorrentService } from 'app/entities/torrent/torrent.service';
import { Torrent } from 'app/shared/model/torrent.model';

describe('Component Tests', () => {
    describe('Torrent Management Component', () => {
        let comp: TorrentComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TorrentComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.torrents[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
